...
#   
#   # 6-10 Under the null - shared but no context specific 
#   c(ParSpace=0, maf = 0.2, hsq = rep(0.02, nT), w_corr = 0.0, alpha = 1),
#   c(ParSpace=0, maf = 0.2, hsq = rep(0.02, nT), w_corr = 0.2, alpha = 1),
#   c(ParSpace=0, maf = 0.2, hsq = rep(0.02, nT), w_corr = 0.4, alpha = 1),
#   c(ParSpace=0, maf = 0.2, hsq = rep(0.02, nT), w_corr = 0.6, alpha = 1),
#   c(ParSpace=0, maf = 0.2, hsq = rep(0.02, nT), w_corr = 0.8, alpha = 1),
#   
#   # 11-15 Single context heterogeneity - no shared effect
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-1),.02), w_corr = 0.0, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-1),.02), w_corr = 0.2, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-1),.02), w_corr = 0.4, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-1),.02), w_corr = 0.6, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-1),.02), w_corr = 0.8, alpha = 1),
#   
#   # 16-20 Single context heterogeneity - shared and context specific 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-1),.04), w_corr = 0.0, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-1),.04), w_corr = 0.2, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-1),.04), w_corr = 0.4, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-1),.04), w_corr = 0.6, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-1),.04), w_corr = 0.8, alpha = 1),
#   
#   # 21-25 Two-context heterogeneity  - no shared effects
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-2),0.02,.02), w_corr = 0.0, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-2),0.02,.02), w_corr = 0.2, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-2),0.02,.02), w_corr = 0.4, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-2),0.02,.02), w_corr = 0.6, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.0, nT-2),0.02,.02), w_corr = 0.8, alpha = 1), 
#   
#   # 26-30 Two-context heterogeneity - shared and context specific 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-2),0.02,.02), w_corr = 0.0, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-2),0.02,.02), w_corr = 0.2, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-2),0.02,.02), w_corr = 0.4, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-2),0.02,.02), w_corr = 0.6, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = c(rep(0.02, nT-2),0.02,.02), w_corr = 0.8, alpha = 1), 
#   
#   # 31-35 Extensive heterogeneity - shared and context specific 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.02, length.out = nT), w_corr = 0.0, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.02, length.out = nT), w_corr = 0.2, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.02, length.out = nT), w_corr = 0.4, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.02, length.out = nT), w_corr = 0.6, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.02, length.out = nT), w_corr = 0.8, alpha = 1), 
#   
#   # 36-40 (Stronger) extensive heterogeneity - shared and context specific 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.05, length.out = nT), w_corr = 0.0, alpha = 1), 
#   c(ParSpace=1, maf = 0.2, hsq = seq(0.0,0.05, length.out = nT), w_corr = 0.2, alpha = 1), 
