...
if(method=="FastGxC") {
  ...
  decompose_median(expression = expression, shared_exp_file_name=shared_exp_file_name, spec_exp_file_name=spec_exp_file_name, genos=genos) # Decompose and save gene expression
}
