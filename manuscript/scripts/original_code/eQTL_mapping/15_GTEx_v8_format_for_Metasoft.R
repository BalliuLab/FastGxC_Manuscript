...
out_file = paste0(outdir, "GTEx", exp_suffix, "_Metasoft_format.txt")
...
parse_sumstats_across_contexts(
 ...
 # MatrixQTL geneloc. need if by chromosome
  ...
  run_by_chrom = T, chroms_to_loop = paste0("chr", cur_chrom), # useful for high mem
